...
export const Home: React.FC = () => {
  return (
    <>
      ...
      <section className="bg-secondary px-3 py-5 md:px-5 md:py-10 lg:px-10 lg:py-18 2xl:px-36 2xl:py-20">
        <div className="block mx-auto max-w-[800px] w-fit mb-10 text-center">
          ...
          <p className="text-neutral-content text-base">
            ...
            aim of creating bridges between different parties, using one or more
            communication channels to convey information, and this is exactly
            where I have always put my skills to good use and where my strength
            lies.
          </p>
        </div>
        <TimeLine />
