  ...
  return (
    <>
      {isLink && linkTo ? (
        <Link
          to={linkTo}
          className={`${className} p-3 text-sm md:text-base rounded-lg bg-primary-500 text-neutral-content relative overflow-hidden group z-10 hover:text-neutral-content duration-1000`}
        >
